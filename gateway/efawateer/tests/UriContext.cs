namespace EfawateerTests
{
    public static class UriContext
    {
        ...
        public const string BillInquiry =        "http://cbj-pres-test.e-fawateer.com.jo:6004/BillInquiry.svc";
        public const string BillPayment =        "http://cbj-pres-test.e-fawateer.com.jo:6003/BillPayment.svc";
        public const string PaymentInquiry =     "http://cbj-pres-test.e-fawateer.com.jo:6019/PaymentInquiry.svc";
        public const string PrepaidPayment =     "http://cbj-pres-test.e-fawateer.com.jo:6017/PrepaidPayment.svc";
        public const string PrepaidValidation =  "http://cbj-pres-test.e-fawateer.com.jo:6018/PrepaidValidation.svc";
    }
}